...
### Purpose
The YouTube Downloader is a command-line application that allows users to download videos from YouTube in the highest available quality. It provides a simple, interactive interface for downloading videos while handling various edge cases and errors gracefully.
...
#### `main()`
- **Purpose**: Main application loop and user interface
- **Features**:
